...
- `geosite.dat`: https://github.com/nobi-k/geosite-custom/releases/latest/download/geosite.dat
- `geoip.dat`: https://github.com/nobi-k/geosite-custom/releases/latest/download/geoip.dat

Обновляется автоматически каждую ночь (22:00 UTC) + при пуше в `master`.

## Добавить свой домен в RU bypass

1. Открой `custom-ru-direct.txt`
2. Добавь домен новой строкой
3. Коммит в `master` — workflow пересоберёт через ~3-5 минут
...
```
https://github.com/nobi-k/geosite-custom/releases/latest/download/geosite.dat
```
